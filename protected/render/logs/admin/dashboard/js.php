...
<script>
    function GetLogErrors(nav) {
        $('#logs-erros-period > button').removeAttr('disabled');
        if (nav) $('#logs-erros-period > button[data-period="' + nav + '"]').attr('disabled', 'disabled');
    ...
    $(document).on('click', "#logs-erros-period > button",function() {
    ...
    $('#logs-erros-period > button[data-period="1 months"]').trigger('click');
</script>