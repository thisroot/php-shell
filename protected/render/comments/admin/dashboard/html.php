...
<div class="btn-group m-b-15">
    <button id="comments-errors-calendar" type="button" class="btn btn-default waves-effect"><i class="zmdi zmdi-calendar"></i> <span id="comments-errors-calendar-from">...</span> - <span id="comments-errors-calendar-to">...</span></button>
</div>
<div id="error-comment-chart">
...
<input id="error-comment-date-from" type="hidden">
<input id="error-comment-date-to" type="hidden">