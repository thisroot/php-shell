...
if ((APP::Module('Users')->user['id'] !== $data['id_user']) && ($data['private'] != -1)) {
    header('Location:' . APP::Module('Routing')->root);
    exit();
}
?>
...
<body data-ma-header="purple-400" id="module-student">
 <? APP::Render('student/widgets/header', 'include', APP::Module('Student')->user_data); ?>
    <section id="main">
        ...
        $(document).ready(function () {
            ...
            $('#user-priv-view').editable({
                ...
                source: [
                    ...
                    {value: 1, text: 'for groups'},
                    {value: 2, text: 'for friends'},
                    {value: 3, text: 'locked'}
                ]
            });
