...
<body>
    <h1>Admin</h1>
    <a href="<?= APP::Module('Routing')->root ?>admin">Admin</a> > <a href="<?= APP::Module('Routing')->root ?>admin/app">Application</a> > Import modules via network
    <hr>
    <?
    switch ($data['action']) {
        case 'set_server':
        ...
        case 'import_modules':
            ...
            <p><?= $_SESSION['core']['import']['modules'] ?></p>
            <a href="<?=APP::$conf['location'][0] . '://' . APP::$conf['location'][1] . APP::$conf['location'][2] ?>admin/app/modules/import/install">Install imported modules</a>
            <?
            break;
    }
    ?>
