...
return [
    'routes' => [
      ...
      ['students\/user\/api\/edit\/lecture.json(\?.*)?',                 'Student', 'APILectureEdit'],     // View all backups /admin
      ...
      ['students\/user\/api\/get\/block\/body.json(\?.*)?',              'Student', 'APIBlockBody'],       // View all backups /admin
